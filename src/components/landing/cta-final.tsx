  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex w-full max-w-7xl flex-col items-center px-4 py-24 text-center md:px-8 md:py-32">
        ...
        <p className="mt-7 max-w-xl text-marble/85 md:text-[17px]">
        ...
        <Link
          href="/login"
          className="mt-10 inline-flex items-center justify-center gap-3 rounded-full bg-marble px-9 py-5 font-sans text-lg font-bold text-shade transition-all hover:bg-chartreuse active:translate-y-px"
