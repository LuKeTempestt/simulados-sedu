    ...
    >
      <div className="mx-auto w-full max-w-7xl px-4 py-20 md:px-8 md:py-28">
        <header className="mb-12 grid gap-6 md:mb-16 md:grid-cols-12 md:gap-8">
          ...
          <p className="text-shade/75 md:col-span-5 md:col-start-8 md:text-[17px]">
        ...
        <div className="grid gap-5 md:grid-cols-12 md:gap-6">
          ...
          >
            <div className="flex flex-wrap items-center gap-3">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-chartreuse px-3 py-1.5 font-mono text-[10px] font-bold uppercase tracking-widest text-shade">
            ...
            <ul className="mt-7 space-y-5">
              <li className="flex gap-4">
                ...
                <p className="text-marble/90 leading-[1.55] md:text-[17px]">
                  ...
                  , acima da média estadual de 64%. A turma demonstra fluência
                  no método da fatoração.
                </p>
              </li>
              <li className="flex gap-4">
                <span
              ...
              <li className="flex gap-4">
                ...
                <p className="text-marble/90 leading-[1.55] md:text-[17px]">
                  ...
                  <strong className="text-poppy">3 a 4 aulas</strong> focadas
                  em geometria analítica antes do próximo simulado, com ênfase
          ...
          <div className="space-y-5 md:col-span-4 md:space-y-6">
            ...
            <article className="rounded-[32px] bg-iris p-7 text-marble md:p-8">
              <span
                aria-hidden
